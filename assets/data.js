...
const I18N = {
  te: {
    ...
    need_people: "నాకు వర్కర్స్ కావాలి",
    need_people_sub: "మీకు కావాల్సిన పని పోస్ట్ చేయండి — దగ్గరలో ఉన్నవారు మీకు కనిపిస్తారు",
    ...
    post_sub: "పోస్ట్ చేసిన తర్వాత, ఆ ప్రాంతంలో ఉన్నవారికి కనిపిస్తుంది. వారు నేరుగా మిమ్మల్ని కాల్/వాట్సాప్ చేస్తారు.",
    more_details: "మరిన్ని వివరాలు చేర్చండి (ఐచ్ఛికం)",
    ...
    post_note: "Submit చేసిన తర్వాత మీ పోస్టింగ్ అందరికీ కనిపిస్తుంది. 📍 Location permission అడిగితే \"Allow\" చేయండి.",
    nearby_work: "దగ్గరలో పని",
    nearby_workers: "దగ్గరలో ఉన్నవారు",
    all_districts: "అన్ని జిల్లాలు",
    list_sub_work: "జిల్లా బట్టి filter చేసుకోండి — దగ్గరలో ఉన్న పని పోస్టింగ్‌లు ఇక్కడ కనిపిస్తాయి.",
    list_sub_workers: "జిల్లా బట్టి filter చేసుకోండి — దగ్గరలో నమోదైనవారు ఇక్కడ కనిపిస్తారు.",
    ...
    empty_workers: "ప్రస్తుతం ఈ ప్రాంతంలో నమోదైనవారు లేరు.<br>తర్వాత మళ్ళీ చూడండి.",
    ...
    no_match: "సరిపోలేవి దొరకలేదు.",
    skill_filter_ph: "🔍 మీరు చేసే పని వెతకండి... (ఉదా: ఎలక్ట్రీషియన్)",
    no_skills_found: "సరిపోలే స్కిల్స్ దొరకలేదు.",
    enter_area_ph: "మీ ఏరియా పేరు రాయండి / Enter Your Area Name",
    post_banner: "మీకు కావాల్సినవారు దొరకలేదా? 📝 పని పోస్ట్ చేయండి — వారే మిమ్మల్ని సంప్రదిస్తారు →",
    shared_profile: "👤 షేర్ చేసిన ప్రొఫైల్",
    see_all_workers: "👥 అందరినీ చూడండి →",
    ...
    share_worker_msg: "👷 *{name}* — {skills}\n📍 {place}\n\nWorkPin లో ఈ ప్రొఫైల్ చూడండి — దగ్గరలో ఉన్నవారు, నేరుగా కాల్:\n{link}",
    ...
    cur_loc_title: "📍 నేను ప్రస్తుతం ఉన్న ప్రాంతం",
    cur_loc_help: "ఊరు మారితే ఇక్కడ మార్చుకోండి — ఆ ప్రాంతంలో పని ఇచ్చేవారికి మీరు కనిపిస్తారు",
    cur_loc_save: "💾 ప్రాంతం సేవ్ చేయండి",
    cur_loc_saved: "✅ మీ ప్రాంతం మారింది!",
    post_expiry_note: "మీ పోస్ట్ 15 రోజులు కనిపిస్తుంది — పని ముందే అయిపోతే WhatsApp చేయండి, తీసేస్తాం.",
    install_app: "📲 WorkPin యాప్‌ను ఫోన్‌లో ఇన్‌స్టాల్ చేసుకోండి — ఒక్క tap లో తెరవండి",
    install_btn: "ఇన్‌స్టాల్ చేయి",
    install_later: "తర్వాత",
    settings: "⚙️ సెట్టింగ్స్",
    quick_ready: "త్వరగా ఎంచుకోండి:",
    q_now: "ఇప్పుడే రెడీ",
    q_team: "టీం ఉంది",
    q_vehicle: "సొంత వాహనం ఉంది",
    q_exp: "అనుభవం ఉంది",
    q_weekend: "వారాంతాల్లో మాత్రమే",
    q_parttime: "పార్ట్ టైం మాత్రమే",
    village_opt: "ఊరు / కాలనీ (optional)",
    add_another: "➕ ఇంకొకరిని చేర్చండి",
    top_skills: "⭐ ఎక్కువగా వెతికేవి",
    settings_title: "సెట్టింగ్స్ & సమాచారం",
    lang_setting: "🌐 భాష / Language",
    s_privacy: "🔒 ప్రైవసీ పాలసీ",
    s_terms: "📄 నిబంధనలు & షరతులు",
    s_help: "💬 సహాయం / Help & Support",
    s_about: "ℹ️ WorkPin గురించి",
    s_share: "📤 WorkPin ను షేర్ చేయండి",
    s_contact: "📞 మమ్మల్ని సంప్రదించండి",
    share_app_msg: "📍 *WorkPin* — దగ్గరలో పని, దగ్గరలో మనుషులు\n\nపని కావాలా? మనుషులు కావాలా? ఉచితంగా నమోదు చేసుకోండి — కమీషన్ లేదు, నేరుగా కాల్ చేసుకోండి:\nhttps://www.workpin.in",
  ...
  en: {
    ...
    post_sub: "After posting, people in that area will see it and call/WhatsApp you directly.",
    more_details: "Add more details (optional)",
    ...
    post_note: "After submitting, your posting will be visible to everyone. 📍 If asked for location permission, tap \"Allow\".",
    nearby_work: "Work nearby",
    nearby_workers: "People nearby",
    all_districts: "All districts",
    list_sub_work: "Filter by district — nearby work postings appear here.",
    list_sub_workers: "Filter by district — nearby registered people appear here.",
    ...
    empty_workers: "No registered people in this area right now.<br>Please check back later.",
    ...
    skill_search_ph: "🔍 Search skill, name or work",
    no_match: "No matches found.",
    skill_filter_ph: "🔍 Search the work you do... (e.g. Electrician)",
    no_skills_found: "No matching skills found.",
    enter_area_ph: "Enter Your Area Name",
    post_banner: "Didn't find who you need? 📝 Post your work — they will contact you →",
    shared_profile: "👤 Shared profile",
    see_all_workers: "👥 See everyone →",
    ...
    share_btn: "📤 Share",
    share_worker_msg: "👷 *{name}* — {skills}\n📍 {place}\n\nView this profile on WorkPin — people nearby, direct call:\n{link}",
    ...
    cur_loc_title: "📍 Where I am right now",
    cur_loc_help: "Changed towns? Update it here — people offering work in that area will see you",
    cur_loc_save: "💾 Save my area",
    cur_loc_saved: "✅ Your area has been updated!",
    post_expiry_note: "Your post stays visible for 15 days — if work is done earlier, WhatsApp us to remove it.",
    install_app: "📲 Install the WorkPin app on your phone — open it in one tap",
    install_btn: "Install",
    install_later: "Later",
    settings: "⚙️ Settings",
    quick_ready: "Quick pick:",
    q_now: "Ready now",
    q_team: "Have a team",
    q_vehicle: "Own vehicle",
    q_exp: "Experienced",
    q_weekend: "Weekends only",
    q_parttime: "Part time only",
    village_opt: "Village / Colony (optional)",
    add_another: "➕ Add another person",
    top_skills: "⭐ Most searched",
    settings_title: "Settings & Info",
    lang_setting: "🌐 భాష / Language",
    s_privacy: "🔒 Privacy Policy",
    s_terms: "📄 Terms & Conditions",
    s_help: "💬 Help & Support",
    s_about: "ℹ️ About WorkPin",
    s_share: "📤 Share WorkPin",
    s_contact: "📞 Contact Us",
    share_app_msg: "📍 *WorkPin* — Work nearby, workers nearby\n\nNeed work? Need workers? Register free — no commission, call directly:\nhttps://www.workpin.in",
...
const SKILL_GROUPS = [
  {
    ...
    items: [
      {te:"వ్యవసాయ డ్రోన్ పైలట్", en:"Agriculture Drone Pilot"},
      {te:"డ్రోన్ స్ప్రేయర్ ఆపరేటర్", en:"Drone Sprayer Operator"},
      {te:"సేంద్రియ వ్యవసాయ సలహాదారు", en:"Organic Farming Consultant"},
      {te:"ఇరిగేషన్ సూపర్‌వైజర్", en:"Irrigation Supervisor"},
  ...
  },
  {
    ...
    items: [
      ...
      {te:"సివిల్ ఇంజనీర్", en:"Civil engineer"},
      {te:"బిల్డింగ్ కాంట్రాక్టర్", en:"Building contractor"},
  ...
  },
  {
    ...
    items: [
      {te:"EV బైక్ మెకానిక్", en:"EV Bike Mechanic"},
      {te:"EV ఛార్జింగ్ స్టేషన్ టెక్నీషియన్", en:"EV Charging Station Technician"},
      {te:"ఫైబర్ ఇంటర్నెట్ టెక్నీషియన్", en:"Fiber Internet Technician"},
      {te:"నెట్‌వర్క్ టెక్నీషియన్", en:"Network Technician"},
      {te:"AC/Fridge మెకానిక్", en:"AC/fridge mechanic"},
      {te:"కూలర్ మెకానిక్", en:"Cooler mechanic"},
      {te:"బీరువా మెకానిక్", en:"Almirah (beeruva) mechanic"},
      {te:"మొబైల్/ఎలక్ట్రానిక్స్ రిపేర్", en:"Mobile/electronics repair"},
      {te:"TV రిపేర్", en:"TV repair"},
      {te:"DTH టెక్నీషియన్", en:"DTH technician"},
      {te:"టైలర్/దర్జీ", en:"Tailor"},
      {te:"బైక్ మెకానిక్", en:"Bike mechanic"},
      {te:"కారు మెకానిక్", en:"Car mechanic"},
      {te:"ఆటో మెకానిక్", en:"Auto mechanic"},
      {te:"టైర్ పంక్చర్/టైర్ వర్క్", en:"Tyre puncture/tyre work"},
      {te:"డెంటింగ్ & పెయింటింగ్", en:"Denting & painting"},
  ...
  },
  {
    ...
    items: [
      {te:"అంబులెన్స్ డ్రైవర్", en:"Ambulance Driver"},
      {te:"డయాలసిస్ టెక్నీషియన్", en:"Dialysis Technician"},
      {te:"ఫిజియోథెరపీ అసిస్టెంట్", en:"Physiotherapy Assistant"},
  ...
  },
  {
    ...
    items: [
      {te:"ఈవెంట్ డెకరేటర్", en:"Event Decorator"},
      {te:"DJ ఆపరేటర్", en:"DJ Operator"},
      {te:"సౌండ్ సిస్టం టెక్నీషియన్", en:"Sound System Technician"},
      {te:"లైటింగ్ టెక్నీషియన్", en:"Lighting Technician"},
  ...
  },
  {
    ...
    items: [
      ...
      {te:"కూరగాయల వ్యాపారి", en:"Vegetable vendor"},
      {te:"పండ్ల వ్యాపారి", en:"Fruit vendor"},
...
const SKILL_GROUPS_URBAN = [
  ...
  },
  {
    ...
    items: [
      ...
      {te:"వాటర్‌ప్రూఫింగ్", en:"Waterproofing"},
      ...
      {te:"సైట్ సూపర్‌వైజర్", en:"Site Supervisor"},
      {te:"JCB ఆపరేటర్", en:"JCB Operator"},
      {te:"క్రేన్ ఆపరేటర్", en:"Crane Operator"},
      {te:"సర్వేయర్ (Land Surveyor)", en:"Land Surveyor"},
      {te:"వాస్తు నిపుణుడు", en:"Vastu consultant"},
      {te:"బోర్‌వెల్ డ్రిల్లింగ్", en:"Borewell drilling"},
      {te:"కోర్ కటింగ్/డ్రిల్లింగ్ వర్క్", en:"Core cutting/drilling work"}
  ...
  },
  {
    ...
    items: [
      ...
      {te:"మెహందీ ఆర్టిస్ట్", en:"Mehendi Artist"},
  ...
  },
  {
    ...
    items: [
      ...
      {te:"ఫిజియోథెరపీ అసిస్టెంట్", en:"Physiotherapy Assistant"},
      {te:"అంబులెన్స్ డ్రైవర్", en:"Ambulance Driver"},
      {te:"మెడికల్ ఎక్విప్‌మెంట్ టెక్నీషియన్", en:"Medical Equipment Technician"},
      {te:"కంపౌండర్", en:"Compounder"},
      {te:"వార్డ్ బాయ్", en:"Ward Boy"},
      {te:"వార్డ్ గర్ల్", en:"Ward Girl"},
      {te:"పేషెంట్ కేర్ అసిస్టెంట్", en:"Patient Care Assistant"},
  ...
  },
  {
    ...
    items: [
      {te:"CNC మెషిన్ ఆపరేటర్", en:"CNC Machine Operator"},
      {te:"లేత్ మెషిన్ ఆపరేటర్", en:"Lathe Machine Operator"},
      {te:"ప్యాకింగ్ సూపర్‌వైజర్", en:"Packing Supervisor"},
  ...
  },
  {
    ...
    items: [
      {te:"ఫోటోగ్రాఫర్ అసిస్టెంట్", en:"Photographer Assistant"},
      {te:"వీడియోగ్రాఫర్ అసిస్టెంట్", en:"Videographer Assistant"},
      {te:"వీడియో ఎడిటర్", en:"Video Editor"},
      {te:"YouTube వీడియో ఎడిటర్", en:"YouTube Video Editor"},
      {te:"సోషల్ మీడియా మేనేజర్", en:"Social Media Manager"},
      {te:"కంటెంట్ క్రియేటర్", en:"Content Creator"},
      {te:"ఫంక్షన్ హాల్ వర్కర్", en:"Function Hall Worker"},
      {te:"సర్వింగ్ స్టాఫ్", en:"Serving Staff"},
  ...
  },
  {
    ...
    items: [
      {te:"EV ఛార్జింగ్ స్టేషన్ టెక్నీషియన్", en:"EV Charging Station Technician"},
      {te:"EV బైక్ మెకానిక్", en:"EV Bike Mechanic"},
      {te:"EV కార్ మెకానిక్", en:"EV Car Mechanic"},
      {te:"ఫైబర్ ఇంటర్నెట్ టెక్నీషియన్", en:"Fiber Internet Technician"},
      {te:"Wi-Fi ఇన్‌స్టాలేషన్ టెక్నీషియన్", en:"Wi-Fi Installation Technician"},
      {te:"నెట్‌వర్క్ టెక్నీషియన్", en:"Network Technician"},
      {te:"బయోమెట్రిక్ డివైస్ టెక్నీషియన్", en:"Biometric Device Technician"},
      {te:"స్మార్ట్ లాక్ ఇన్‌స్టాలర్", en:"Smart Lock Installer"},
      {te:"వీడియో డోర్ ఫోన్ ఇన్‌స్టాలర్", en:"Video Door Phone Installer"},
      {te:"హోమ్ ఆటోమేషన్ టెక్నీషియన్", en:"Home Automation Technician"},
      {te:"RO వాటర్ ప్యూరిఫైయర్ టెక్నీషియన్", en:"RO Water Purifier Technician"},
      {te:"వాషింగ్ మెషిన్ రిపేర్", en:"Washing Machine Repair"},
      {te:"TV రిపేర్", en:"TV Repair"},
      {te:"ఇంటి ఉపకరణాల రిపేర్ (గీజర్/మిక్సీ/మైక్రోవేవ్/చిమ్నీ)", en:"Home Appliance Repair (Geyser/Mixer/Microwave/Chimney)"},
      {te:"కంప్యూటర్/లాప్‌టాప్ రిపేర్", en:"Computer / Laptop Repair"},
      {te:"DTH టెక్నీషియన్", en:"DTH Technician"},
      ...
      {te:"డీప్ క్లీనింగ్ (బాత్రూమ్/కిచెన్/సోఫా)", en:"Deep Cleaning (Bathroom/Kitchen/Sofa)"},
      {te:"బైక్ మెకానిక్", en:"Bike Mechanic"},
      {te:"కారు మెకానిక్", en:"Car Mechanic"},
      {te:"ఆటో మెకానిక్", en:"Auto Mechanic"},
      {te:"టైర్ పంక్చర్/టైర్ వర్క్", en:"Tyre Puncture / Tyre Work"},
